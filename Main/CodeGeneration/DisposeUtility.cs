                ...
                $$"""
                  internal class {{_syncDisposalTriggeredExceptionName}} : {{_wellKnownTypes.Exception.FullName()}}
                  {
                      ...
                      internal {{_syncDisposalTriggeredExceptionName}}({{_wellKnownTypes.Task.FullName()}} asyncDisposal)
                          : base("MsMeeseeks.DIE: Sync disposal triggered where the async disposal may be necessary. Await the AsyncDisposal property to make sure the async disposal is completed.")
                      {
                      ...
                      internal {{_syncDisposalTriggeredExceptionName}}({{_wellKnownTypes.Task.FullName()}} asyncDisposal, {{_wellKnownTypes.Exception.FullName()}} exception) 
                          : base("MsMeeseeks.DIE: Sync disposal triggered where the async disposal may be necessary. Await the AsyncDisposal property to make sure the async disposal is completed.", exception)
                      {
                          AsyncDisposal = asyncDisposal;
                          Exception = exception;
                      }
